        ...
        <div className="space-y-6 pb-20">
            ...
            <div className="min-h-[50vh]">
                {filteredRecords.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-16 text-muted-foreground bg-accent/20 dark:bg-gray-800/50 rounded-3xl border-dashed border-2 dark:border-gray-700 animate-in fade-in zoom-in duration-500">
                        ...
                        {filteredRecords.map((record: any, index: number) => {
                            ...
                            return (
                                <div
                                    key={record.id}
                                    className={cn(
                                        "relative overflow-hidden rounded-[2rem] p-6 transition-all hover:shadow-md border animate-in fade-in slide-in-from-bottom-8 duration-700",
                                        isPresent
