...
export default function EmailPage() {
    ...
    const fetchLogs = async (background: boolean = false) => {
        ...
        try {
            const res = await fetch(`/api/tuition/email-logs?limit=${visibleCount}`);
            const data = await res.json();
            if (data.logs) {
    ...
    const onSendGeneralEmail = async (data: any) => {
        ...
        setStatus(null);
        try {
            const res = await fetch("/api/tuition/send-email", {
                method: "POST",
    ...
    const onSendReport = async () => {
        ...
        try {
            ...
            const res = await fetch("/api/tuition/send-report", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    const onResend = async (logId: string) => {
        ...
        setStatus(null);
        try {
            const res = await fetch("/api/tuition/resend-email", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
