...
export const getResetPasswordEmailHtml = (resetLink: string) => {
    const content = `
        <div style="text-align: left; margin-bottom: 32px;">
            ...
            <p class="secondary-text" style="font-size: 16px; color: #86868b; margin: 0;">We received a request to reset your password.</p>
        </div>

        <div style="margin-bottom: 32px; text-align: left;">
            <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.5; color: #1d1d1f;">
